...
\projectinfo{
  ...
  title.cs={Automatická kvantizace neuronových sítí},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Automatic Quantization of Neural Networks}, % název práce v angličtině / thesis title in english
  ...
  %Autor / Author
  author.name={Miroslav},   % jméno autora / author name
  author.surname={Šafář},   % příjmení autora / author surname 
  ...
  keywords.cs={kvantizace, neuronové sítě, evoluční algoritmy, automatický návrh neuronových sítí, automatická kvantizace, per-channel kvantizace, kvantizace se smíšenou přesností, kvantizace batch normalizace, tensorflow}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={quantization, neural networks, evolutionary algorithm, automated design, automated quantization, per-channel quantization, mixed-precision quantization, batch normalization quantization, tensorflow}, % klíčová slova v anglickém jazyce / keywords in english
...
Kvantizace hlubokých neuronových sítí je častou technikou optimalizace jejich paměťové a~energetické náročnosti, aby mohly být nasazeny na zařízení s~omezenými zdroji. Kvantizace se smíšenou přesností umožňuje ještě lepší paměťové a~energetické úspory. Volba kvantizačních úrovní jednotlivých vrstev však vyžaduje odborné znalosti a~hlubokou analýzu sítě, což je časově velmi  náročná činnost. V této bakalářské práci se věnuji návrhu systému pro automatické určování kvantizační úrovně jednotlivých vrstev vstupní neuronové sítě. Využívám k~tomu evoluční algoritmus NSGA-II a~quantization-aware učení k~doladění parametrů kvantizované sítě. S navrženým systémem jsem provedl experimenty s~neuronovou sítí MobileNet a~podmnožinou datové sady ImageNet. Navržený systém nalezl řešení, které téměř desetkrát zmenšuje velikost modelu při zachování jeho Top-1 klasifikační přesnosti, což v~tomto případě  překonalo uniformní kvantizaci téměř o 100 \%. Tyto úspory lze využít ke~snížení výrobních nákladů pamětí do hardwarových akcelerátorů nebo k~nasazení hlubokých neuronových sítí na~ještě menší zařízení.
  ...
  declaration={Prohlašuji, že jsem tuto bakalářskou práci vypracoval samostatně pod vedením pana Ing.~Vojtěcha~Mrázka~Ph.D.
...
% I have listed all the literary sources, publications and other sources, which were used during the preparation of this thesis.},
  ...
  acknowledgment={
  Děkuji svému vedoucímu doktoru Vojtěchu Mrázkovi za cenné rady, nápady a informace, které mi pomohly zpracovat tuto práci, své přítelkyni za podporu v~posledních měsících a~svým rodičům za jejich důvěru ve mě.
  ...
  Tato práce byla podpořena Grantovou agenturou České republiky projekt GA22-02067S.
},
