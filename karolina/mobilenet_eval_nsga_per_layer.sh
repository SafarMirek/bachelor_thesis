#!/usr/bin/env bash
#PBS -q qgpu
#PBS -N evalNSGAPerLayerAsymmetric
...
python3 nsga_evaluate.py --multigpu --run nsga_runs/${RUN} --learning-rate 0.0025 --batch-size 64 --approx --epochs 50 --bn-freeze 40 --act-quant-wait 20 --logs-dir-pattern logs/mobilenet/mobilenet_025_qat_12_no_act_approx_per_layer_asymmetric_24pch_24h/%s --checkpoints-dir-pattern checkpoints/mobilenet/mobilenet_025_qat_12_no_act_approx_per_layer_asymmetric_24pch_24h/%s
